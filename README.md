...
- 🌐 Atuo no desenvolvimento de sites institucionais em **WordPress + Elementor**  
...
Atualmente trabalho com **desenvolvimento de sites profissionais em WordPress**, utilizando:

- **Elementor** para criação e personalização de interfaces  
- **Boas práticas de UX/UI** para melhorar a experiência do usuário  
- **Organização estrutural de páginas e componentes**  
- **Configuração de menus, templates, rodapés, plugins e identidade visual**  
- **Ajustes visuais, responsividade e manutenção contínua**
...
<p>
  ...
  <img src="https://img.shields.io/badge/Assembly_MIPS-6E4C13?style=for-the-badge"/>
...
Desenvolvimento do site usando tema personalizado e interface baseada em design criado no Figma.
🔗 *https://comus.cnat.ifrn.edu.br*

### 🎨**Protótipo Figma — Interface do site no Behance**
